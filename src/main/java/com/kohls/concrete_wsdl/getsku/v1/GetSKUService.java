 ...
 * 2019-03-14T12:45:57.440+02:00
 * Generated source version: 3.3.1
 *
 */
@WebServiceClient(name = "GetSKUService",
                  wsdlLocation = "file:/C:/PRJ/WebServicePMDM/src/main/resources/GetSKU.wsdl",
...
public class GetSKUService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/PRJ/WebServicePMDM/src/main/resources/GetSKU.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GetSKUService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/PRJ/WebServicePMDM/src/main/resources/GetSKU.wsdl");
        }
        WSDL_LOCATION = url;
    }
