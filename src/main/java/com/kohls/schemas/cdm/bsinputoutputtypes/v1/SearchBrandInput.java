...
import com.kohls.schemas.cdm.producttypescdm.v1.BrandType;
...
@XmlRootElement(name = "SearchBrandInput")
public class SearchBrandInput {

    @XmlElement(name = "Brand", namespace = "http://www.kohls.com/schemas/cdm/ProductTypesCDM/V1")
