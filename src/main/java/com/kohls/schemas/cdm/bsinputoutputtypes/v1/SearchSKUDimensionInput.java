 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.kohls.com/schemas/cdm/ProductTypesCDM/V1}SKUDimension" minOccurs="0"/&gt;
...
@XmlRootElement(name = "SearchSKUDimensionInput")
public class SearchSKUDimensionInput {

    @XmlElement(name = "SKUDimension", namespace = "http://www.kohls.com/schemas/cdm/ProductTypesCDM/V1")
    protected SKUDimensionType skuDimension;
     ...
     *     
     */
    public SKUDimensionType getSKUDimension() {
        return skuDimension;
    }

    /**
     * Sets the value of the skuDimension property.
     * 
     * @param value
     *     allowed object is
     *     {@link SKUDimensionType }
     *     
     */
    public void setSKUDimension(SKUDimensionType value) {
        this.skuDimension = value;
    }
