...
import com.kohls.schemas.cdm.producttypescdm.v1.ColorType;
...
@XmlRootElement(name = "SearchColorInput")
public class SearchColorInput {

    @XmlElement(name = "Color", namespace = "http://www.kohls.com/schemas/cdm/ProductTypesCDM/V1")
