...
import com.kohls.schemas.cdm.producttypescdm.v1.ConsumerProductType;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.kohls.com/schemas/cdm/ProductTypesCDM/V1}ConsumerProduct" minOccurs="0"/&gt;
...
@XmlRootElement(name = "SearchConsumerProductInput")
public class SearchConsumerProductInput {

    @XmlElement(name = "ConsumerProduct", namespace = "http://www.kohls.com/schemas/cdm/ProductTypesCDM/V1")
    protected ConsumerProductType consumerProduct;
     ...
     *     
     */
    public ConsumerProductType getConsumerProduct() {
        return consumerProduct;
    }

    /**
     * Sets the value of the consumerProduct property.
     * 
     * @param value
     *     allowed object is
     *     {@link ConsumerProductType }
     *     
     */
    public void setConsumerProduct(ConsumerProductType value) {
        this.consumerProduct = value;
    }
