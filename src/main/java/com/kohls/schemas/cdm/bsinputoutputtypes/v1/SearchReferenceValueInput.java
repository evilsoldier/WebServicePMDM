...
import com.kohls.schemas.cdm.producttypescdm.v1.ReferenceValueType;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.kohls.com/schemas/cdm/ProductTypesCDM/V1}ReferenceValue" minOccurs="0"/&gt;
...
@XmlRootElement(name = "SearchReferenceValueInput")
public class SearchReferenceValueInput {

    @XmlElement(name = "ReferenceValue", namespace = "http://www.kohls.com/schemas/cdm/ProductTypesCDM/V1")
    protected ReferenceValueType referenceValue;
     ...
     *     
     */
    public ReferenceValueType getReferenceValue() {
     ...
     *     
     */
    public void setReferenceValue(ReferenceValueType value) {
